...
module lab4_mm_interconnect_2 (
		...
		output wire [1:0]  cont_s1_address,                                                     //                                                       cont_s1.address
		output wire        cont_s1_write,                                                       //                                                              .write
		input  wire [31:0] cont_s1_readdata,                                                    //                                                              .readdata
		output wire [31:0] cont_s1_writedata,                                                   //                                                              .writedata
		output wire        cont_s1_chipselect,                                                  //                                                              .chipselect
	...
	wire  [116:0] ready_s1_agent_rf_source_data;                                     // ready_s1_agent:rf_source_data -> ready_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] ready_s1_agent_rsp_fifo_out_data;                                  // ready_s1_agent_rsp_fifo:out_data -> ready_s1_agent:rf_sink_data
	...
	wire   [31:0] cont_s1_agent_m0_readdata;                                         // cont_s1_translator:uav_readdata -> cont_s1_agent:m0_readdata
	wire          cont_s1_agent_m0_waitrequest;                                      // cont_s1_translator:uav_waitrequest -> cont_s1_agent:m0_waitrequest
	wire          cont_s1_agent_m0_debugaccess;                                      // cont_s1_agent:m0_debugaccess -> cont_s1_translator:uav_debugaccess
	wire   [20:0] cont_s1_agent_m0_address;                                          // cont_s1_agent:m0_address -> cont_s1_translator:uav_address
	wire    [3:0] cont_s1_agent_m0_byteenable;                                       // cont_s1_agent:m0_byteenable -> cont_s1_translator:uav_byteenable
	wire          cont_s1_agent_m0_read;                                             // cont_s1_agent:m0_read -> cont_s1_translator:uav_read
	wire          cont_s1_agent_m0_readdatavalid;                                    // cont_s1_translator:uav_readdatavalid -> cont_s1_agent:m0_readdatavalid
	wire          cont_s1_agent_m0_lock;                                             // cont_s1_agent:m0_lock -> cont_s1_translator:uav_lock
	wire   [31:0] cont_s1_agent_m0_writedata;                                        // cont_s1_agent:m0_writedata -> cont_s1_translator:uav_writedata
	wire          cont_s1_agent_m0_write;                                            // cont_s1_agent:m0_write -> cont_s1_translator:uav_write
	wire    [2:0] cont_s1_agent_m0_burstcount;                                       // cont_s1_agent:m0_burstcount -> cont_s1_translator:uav_burstcount
	wire          cont_s1_agent_rf_source_valid;                                     // cont_s1_agent:rf_source_valid -> cont_s1_agent_rsp_fifo:in_valid
	wire  [116:0] cont_s1_agent_rf_source_data;                                      // cont_s1_agent:rf_source_data -> cont_s1_agent_rsp_fifo:in_data
	wire          cont_s1_agent_rf_source_ready;                                     // cont_s1_agent_rsp_fifo:in_ready -> cont_s1_agent:rf_source_ready
	wire          cont_s1_agent_rf_source_startofpacket;                             // cont_s1_agent:rf_source_startofpacket -> cont_s1_agent_rsp_fifo:in_startofpacket
	wire          cont_s1_agent_rf_source_endofpacket;                               // cont_s1_agent:rf_source_endofpacket -> cont_s1_agent_rsp_fifo:in_endofpacket
	wire          cont_s1_agent_rsp_fifo_out_valid;                                  // cont_s1_agent_rsp_fifo:out_valid -> cont_s1_agent:rf_sink_valid
	wire  [116:0] cont_s1_agent_rsp_fifo_out_data;                                   // cont_s1_agent_rsp_fifo:out_data -> cont_s1_agent:rf_sink_data
	wire          cont_s1_agent_rsp_fifo_out_ready;                                  // cont_s1_agent:rf_sink_ready -> cont_s1_agent_rsp_fifo:out_ready
	wire          cont_s1_agent_rsp_fifo_out_startofpacket;                          // cont_s1_agent_rsp_fifo:out_startofpacket -> cont_s1_agent:rf_sink_startofpacket
	wire          cont_s1_agent_rsp_fifo_out_endofpacket;                            // cont_s1_agent_rsp_fifo:out_endofpacket -> cont_s1_agent:rf_sink_endofpacket
	wire          cont_s1_agent_rdata_fifo_src_valid;                                // cont_s1_agent:rdata_fifo_src_valid -> cont_s1_agent_rdata_fifo:in_valid
	wire   [33:0] cont_s1_agent_rdata_fifo_src_data;                                 // cont_s1_agent:rdata_fifo_src_data -> cont_s1_agent_rdata_fifo:in_data
	wire          cont_s1_agent_rdata_fifo_src_ready;                                // cont_s1_agent_rdata_fifo:in_ready -> cont_s1_agent:rdata_fifo_src_ready
	...
	wire  [116:0] done_s1_agent_rf_source_data;                                      // done_s1_agent:rf_source_data -> done_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] done_s1_agent_rsp_fifo_out_data;                                   // done_s1_agent_rsp_fifo:out_data -> done_s1_agent:rf_sink_data
	...
	wire  [115:0] sw_s1_agent_rp_data;                                               // sw_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] ready_s1_agent_rp_data;                                            // ready_s1_agent:rp_data -> router_007:sink_data
	...
	wire          cont_s1_agent_rp_valid;                                            // cont_s1_agent:rp_valid -> router_008:sink_valid
	wire  [115:0] cont_s1_agent_rp_data;                                             // cont_s1_agent:rp_data -> router_008:sink_data
	wire          cont_s1_agent_rp_ready;                                            // router_008:sink_ready -> cont_s1_agent:rp_ready
	wire          cont_s1_agent_rp_startofpacket;                                    // cont_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          cont_s1_agent_rp_endofpacket;                                      // cont_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          done_s1_agent_rp_valid;                                            // done_s1_agent:rp_valid -> router_009:sink_valid
	wire  [115:0] done_s1_agent_rp_data;                                             // done_s1_agent:rp_data -> router_009:sink_data
	wire          done_s1_agent_rp_ready;                                            // router_009:sink_ready -> done_s1_agent:rp_ready
	wire          done_s1_agent_rp_startofpacket;                                    // done_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          done_s1_agent_rp_endofpacket;                                      // done_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire    [7:0] cmd_mux_002_src_channel;                                           // cmd_mux_002:src_channel -> sysid_qsys_0_control_slave_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> sw_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                             // sw_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                           // cmd_mux_003:src_channel -> sw_s1_burst_adapter:sink0_channel
	...
	wire    [7:0] cmd_mux_004_src_channel;                                           // cmd_mux_004:src_channel -> led_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                              // cmd_mux_005:src_data -> ready_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                             // ready_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                           // cmd_mux_005:src_channel -> ready_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] ready_s1_burst_adapter_source0_data;                               // ready_s1_burst_adapter:source0_data -> ready_s1_agent:cp_data
	wire          ready_s1_burst_adapter_source0_ready;                              // ready_s1_agent:cp_ready -> ready_s1_burst_adapter:source0_ready
	wire    [7:0] ready_s1_burst_adapter_source0_channel;                            // ready_s1_burst_adapter:source0_channel -> ready_s1_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                             // cmd_mux_006:src_valid -> cont_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_006_src_data;                                              // cmd_mux_006:src_data -> cont_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                             // cont_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                           // cmd_mux_006:src_channel -> cont_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                     // cmd_mux_006:src_startofpacket -> cont_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                       // cmd_mux_006:src_endofpacket -> cont_s1_burst_adapter:sink0_endofpacket
	wire          cont_s1_burst_adapter_source0_valid;                               // cont_s1_burst_adapter:source0_valid -> cont_s1_agent:cp_valid
	wire  [115:0] cont_s1_burst_adapter_source0_data;                                // cont_s1_burst_adapter:source0_data -> cont_s1_agent:cp_data
	wire          cont_s1_burst_adapter_source0_ready;                               // cont_s1_agent:cp_ready -> cont_s1_burst_adapter:source0_ready
	wire    [7:0] cont_s1_burst_adapter_source0_channel;                             // cont_s1_burst_adapter:source0_channel -> cont_s1_agent:cp_channel
	wire          cont_s1_burst_adapter_source0_startofpacket;                       // cont_s1_burst_adapter:source0_startofpacket -> cont_s1_agent:cp_startofpacket
	wire          cont_s1_burst_adapter_source0_endofpacket;                         // cont_s1_burst_adapter:source0_endofpacket -> cont_s1_agent:cp_endofpacket
	wire          cmd_mux_007_src_valid;                                             // cmd_mux_007:src_valid -> done_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_007_src_data;                                              // cmd_mux_007:src_data -> done_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                             // done_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                           // cmd_mux_007:src_channel -> done_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                     // cmd_mux_007:src_startofpacket -> done_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                       // cmd_mux_007:src_endofpacket -> done_s1_burst_adapter:sink0_endofpacket
	wire          done_s1_burst_adapter_source0_valid;                               // done_s1_burst_adapter:source0_valid -> done_s1_agent:cp_valid
	wire  [115:0] done_s1_burst_adapter_source0_data;                                // done_s1_burst_adapter:source0_data -> done_s1_agent:cp_data
	...
	wire          cont_s1_agent_rdata_fifo_out_valid;                                // cont_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] cont_s1_agent_rdata_fifo_out_data;                                 // cont_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          cont_s1_agent_rdata_fifo_out_ready;                                // avalon_st_adapter_006:in_0_ready -> cont_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                 // avalon_st_adapter_006:out_0_valid -> cont_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                  // avalon_st_adapter_006:out_0_data -> cont_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                 // cont_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                 // avalon_st_adapter_006:out_0_error -> cont_s1_agent:rdata_fifo_sink_error
	wire          done_s1_agent_rdata_fifo_out_valid;                                // done_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] done_s1_agent_rdata_fifo_out_data;                                 // done_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          done_s1_agent_rdata_fifo_out_ready;                                // avalon_st_adapter_007:in_0_ready -> done_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_007_out_0_valid;                                 // avalon_st_adapter_007:out_0_valid -> done_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                  // avalon_st_adapter_007:out_0_data -> done_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                 // done_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                 // avalon_st_adapter_007:out_0_error -> done_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (sys_sdram_pll_0_sys_clk_clk),                   //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (cont_s1_agent_m0_address),                      // avalon_universal_slave_0.address
		.uav_burstcount         (cont_s1_agent_m0_burstcount),                   //                         .burstcount
		.uav_read               (cont_s1_agent_m0_read),                         //                         .read
		.uav_write              (cont_s1_agent_m0_write),                        //                         .write
		.uav_waitrequest        (cont_s1_agent_m0_waitrequest),                  //                         .waitrequest
		.uav_readdatavalid      (cont_s1_agent_m0_readdatavalid),                //                         .readdatavalid
		.uav_byteenable         (cont_s1_agent_m0_byteenable),                   //                         .byteenable
		.uav_readdata           (cont_s1_agent_m0_readdata),                     //                         .readdata
		.uav_writedata          (cont_s1_agent_m0_writedata),                    //                         .writedata
		.uav_lock               (cont_s1_agent_m0_lock),                         //                         .lock
		.uav_debugaccess        (cont_s1_agent_m0_debugaccess),                  //                         .debugaccess
		.av_address             (cont_s1_address),                               //      avalon_anti_slave_0.address
		.av_write               (cont_s1_write),                                 //                         .write
		.av_readdata            (cont_s1_readdata),                              //                         .readdata
		.av_writedata           (cont_s1_writedata),                             //                         .writedata
		.av_chipselect          (cont_s1_chipselect),                            //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (sys_sdram_pll_0_sys_clk_clk),                   //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (cont_s1_agent_m0_address),                      //              m0.address
		.m0_burstcount           (cont_s1_agent_m0_burstcount),                   //                .burstcount
		.m0_byteenable           (cont_s1_agent_m0_byteenable),                   //                .byteenable
		.m0_debugaccess          (cont_s1_agent_m0_debugaccess),                  //                .debugaccess
		.m0_lock                 (cont_s1_agent_m0_lock),                         //                .lock
		.m0_readdata             (cont_s1_agent_m0_readdata),                     //                .readdata
		.m0_readdatavalid        (cont_s1_agent_m0_readdatavalid),                //                .readdatavalid
		.m0_read                 (cont_s1_agent_m0_read),                         //                .read
		.m0_waitrequest          (cont_s1_agent_m0_waitrequest),                  //                .waitrequest
		.m0_writedata            (cont_s1_agent_m0_writedata),                    //                .writedata
		.m0_write                (cont_s1_agent_m0_write),                        //                .write
		.rp_endofpacket          (cont_s1_agent_rp_endofpacket),                  //              rp.endofpacket
		.rp_ready                (cont_s1_agent_rp_ready),                        //                .ready
		.rp_valid                (cont_s1_agent_rp_valid),                        //                .valid
		.rp_data                 (cont_s1_agent_rp_data),                         //                .data
		.rp_startofpacket        (cont_s1_agent_rp_startofpacket),                //                .startofpacket
		.cp_ready                (cont_s1_burst_adapter_source0_ready),           //              cp.ready
		.cp_valid                (cont_s1_burst_adapter_source0_valid),           //                .valid
		.cp_data                 (cont_s1_burst_adapter_source0_data),            //                .data
		.cp_startofpacket        (cont_s1_burst_adapter_source0_startofpacket),   //                .startofpacket
		.cp_endofpacket          (cont_s1_burst_adapter_source0_endofpacket),     //                .endofpacket
		.cp_channel              (cont_s1_burst_adapter_source0_channel),         //                .channel
		.rf_sink_ready           (cont_s1_agent_rsp_fifo_out_ready),              //         rf_sink.ready
		.rf_sink_valid           (cont_s1_agent_rsp_fifo_out_valid),              //                .valid
		.rf_sink_startofpacket   (cont_s1_agent_rsp_fifo_out_startofpacket),      //                .startofpacket
		.rf_sink_endofpacket     (cont_s1_agent_rsp_fifo_out_endofpacket),        //                .endofpacket
		.rf_sink_data            (cont_s1_agent_rsp_fifo_out_data),               //                .data
		.rf_source_ready         (cont_s1_agent_rf_source_ready),                 //       rf_source.ready
		.rf_source_valid         (cont_s1_agent_rf_source_valid),                 //                .valid
		.rf_source_startofpacket (cont_s1_agent_rf_source_startofpacket),         //                .startofpacket
		.rf_source_endofpacket   (cont_s1_agent_rf_source_endofpacket),           //                .endofpacket
		.rf_source_data          (cont_s1_agent_rf_source_data),                  //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),             //                .error
		.rdata_fifo_src_ready    (cont_s1_agent_rdata_fifo_src_ready),            //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (cont_s1_agent_rdata_fifo_src_valid),            //                .valid
		.rdata_fifo_src_data     (cont_s1_agent_rdata_fifo_src_data),             //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cont_s1_agent_rsp_fifo (
		.clk               (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (cont_s1_agent_rf_source_data),                  //        in.data
		.in_valid          (cont_s1_agent_rf_source_valid),                 //          .valid
		.in_ready          (cont_s1_agent_rf_source_ready),                 //          .ready
		.in_startofpacket  (cont_s1_agent_rf_source_startofpacket),         //          .startofpacket
		.in_endofpacket    (cont_s1_agent_rf_source_endofpacket),           //          .endofpacket
		.out_data          (cont_s1_agent_rsp_fifo_out_data),               //       out.data
		.out_valid         (cont_s1_agent_rsp_fifo_out_valid),              //          .valid
		.out_ready         (cont_s1_agent_rsp_fifo_out_ready),              //          .ready
		.out_startofpacket (cont_s1_agent_rsp_fifo_out_startofpacket),      //          .startofpacket
		.out_endofpacket   (cont_s1_agent_rsp_fifo_out_endofpacket),        //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cont_s1_agent_rdata_fifo (
		.clk               (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (cont_s1_agent_rdata_fifo_src_data),             //        in.data
		.in_valid          (cont_s1_agent_rdata_fifo_src_valid),            //          .valid
		.in_ready          (cont_s1_agent_rdata_fifo_src_ready),            //          .ready
		.out_data          (cont_s1_agent_rdata_fifo_out_data),             //       out.data
		.out_valid         (cont_s1_agent_rdata_fifo_out_valid),            //          .valid
		.out_ready         (cont_s1_agent_rdata_fifo_out_ready),            //          .ready
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	lab4_mm_interconnect_2_router_002 router_008 (
		.sink_ready         (cont_s1_agent_rp_ready),                        //      sink.ready
		.sink_valid         (cont_s1_agent_rp_valid),                        //          .valid
		.sink_data          (cont_s1_agent_rp_data),                         //          .data
		.sink_startofpacket (cont_s1_agent_rp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (cont_s1_agent_rp_endofpacket),                  //          .endofpacket
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (cont_s1_burst_adapter_source0_valid),           //   source0.valid
		.source0_data          (cont_s1_burst_adapter_source0_data),            //          .data
		.source0_channel       (cont_s1_burst_adapter_source0_channel),         //          .channel
		.source0_startofpacket (cont_s1_burst_adapter_source0_startofpacket),   //          .startofpacket
		.source0_endofpacket   (cont_s1_burst_adapter_source0_endofpacket),     //          .endofpacket
		.source0_ready         (cont_s1_burst_adapter_source0_ready)            //          .ready
	);
	...
	lab4_mm_interconnect_2_avalon_st_adapter #(
		...
		.in_clk_0_clk   (sys_sdram_pll_0_sys_clk_clk),                   // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (cont_s1_agent_rdata_fifo_out_data),             //     in_0.data
		.in_0_valid     (cont_s1_agent_rdata_fifo_out_valid),            //         .valid
		.in_0_ready     (cont_s1_agent_rdata_fifo_out_ready),            //         .ready
